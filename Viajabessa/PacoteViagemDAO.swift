...
class PacoteViagemDAO: NSObject {
    ...
    func retornaTodasViagens() -> Array<PacoteViagem> {
        ...
        let pacote1 = PacoteViagem(nomeDoHotel: "Ceara's Hotel", descricao: "Pacote: Hotel + café da manhã", dataViagem: "01~07 de dezembro", quantidadePessoas: "2 adultos", viagem: ceara)
        let pacote2 = PacoteViagem(nomeDoHotel: "Copacabana Palace", descricao: "Pacote: Hotel + café da manhã", dataViagem: "09~16 de dezembro", quantidadePessoas: "2 adultos", viagem: riodejaneiro)
        ...
        let pacote5 = PacoteViagem(nomeDoHotel: "Idiana Forest", descricao: "Pacote: Hotel + café da manhã", dataViagem: "10~16 de janeiro", quantidadePessoas: "2 adultos", viagem: amazonas)
